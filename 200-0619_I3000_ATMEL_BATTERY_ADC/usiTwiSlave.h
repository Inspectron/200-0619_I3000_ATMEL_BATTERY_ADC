...
Change Activity:
  ...
  START HWBASE ACK ADDRESS ACK DATA STOP
  
  TWI READ:
  
  START	0b11001110 ACK REGISTER ACK RESTART 0b11001111 ACK DATA STOP
...
uint8_t	gTWISlaveWriteRequest;
uint8_t	gTWISlaveReadRequest;
